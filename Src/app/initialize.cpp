...
VulkanDevice::QueueFamilyIndices VulkanDevice::FindQueueFamilyIndex(VkPhysicalDevice device) {
...
void VulkanDevice::CreateLogicalDevice() {
    QueueFamilyIndices indices = FindQueueFamilyIndex(_physicalDevice);
...
void VulkanDevice::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
